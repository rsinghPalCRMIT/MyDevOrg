...
declare module "@salesforce/schema/Account.ConnectionReceived" {
  const ConnectionReceived:any;
  export default ConnectionReceived;
}
declare module "@salesforce/schema/Account.ConnectionReceivedId" {
  const ConnectionReceivedId:any;
  export default ConnectionReceivedId;
}
declare module "@salesforce/schema/Account.ConnectionSent" {
  const ConnectionSent:any;
  export default ConnectionSent;
}
declare module "@salesforce/schema/Account.ConnectionSentId" {
...
declare module "@salesforce/schema/Account.Company_Email__c" {
  const Company_Email__c:string;
  export default Company_Email__c;
}
declare module "@salesforce/schema/Account.VIP_Account__c" {
  const VIP_Account__c:boolean;
  export default VIP_Account__c;
}
declare module "@salesforce/schema/Account.Rollup_Amount_X__c" {
  const Rollup_Amount_X__c:number;
  export default Rollup_Amount_X__c;
}
declare module "@salesforce/schema/Account.Rollup_Amount_Y__c" {
  const Rollup_Amount_Y__c:number;
  export default Rollup_Amount_Y__c;
}
declare module "@salesforce/schema/Account.Rollup_Amount__c" {
  const Rollup_Amount__c:number;
  export default Rollup_Amount__c;
}
declare module "@salesforce/schema/Account.Text_Area__c" {
  const Text_Area__c:string;
  export default Text_Area__c;
}
