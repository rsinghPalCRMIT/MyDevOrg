...
declare module "@salesforce/schema/AccountChangeEvent.Company_Email__c" {
  const Company_Email__c:string;
  export default Company_Email__c;
}
declare module "@salesforce/schema/AccountChangeEvent.VIP_Account__c" {
  const VIP_Account__c:boolean;
  export default VIP_Account__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Rollup_Amount_X__c" {
  const Rollup_Amount_X__c:number;
  export default Rollup_Amount_X__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Rollup_Amount_Y__c" {
  const Rollup_Amount_Y__c:number;
  export default Rollup_Amount_Y__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Rollup_Amount__c" {
  const Rollup_Amount__c:number;
  export default Rollup_Amount__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Text_Area__c" {
