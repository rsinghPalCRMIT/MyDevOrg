...
declare module "@salesforce/schema/Case.ConnectionReceived" {
  const ConnectionReceived:any;
  export default ConnectionReceived;
}
declare module "@salesforce/schema/Case.ConnectionReceivedId" {
  const ConnectionReceivedId:any;
  export default ConnectionReceivedId;
}
declare module "@salesforce/schema/Case.ConnectionSent" {
  const ConnectionSent:any;
  export default ConnectionSent;
}
declare module "@salesforce/schema/Case.ConnectionSentId" {
...
declare module "@salesforce/schema/Case.Fulfillment__r" {
  const Fulfillment__r:any;
  export default Fulfillment__r;
}
declare module "@salesforce/schema/Case.Fulfillment__c" {
  const Fulfillment__c:any;
  export default Fulfillment__c;
}
declare module "@salesforce/schema/Case.Case_Email__c" {
  const Case_Email__c:string;
  export default Case_Email__c;
}
