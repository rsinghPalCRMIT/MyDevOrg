...
declare module "@salesforce/schema/Contact.ConnectionReceived" {
  const ConnectionReceived:any;
  export default ConnectionReceived;
}
declare module "@salesforce/schema/Contact.ConnectionReceivedId" {
  const ConnectionReceivedId:any;
  export default ConnectionReceivedId;
}
declare module "@salesforce/schema/Contact.ConnectionSent" {
  const ConnectionSent:any;
  export default ConnectionSent;
}
declare module "@salesforce/schema/Contact.ConnectionSentId" {
...
declare module "@salesforce/schema/Contact.Amount_X__c" {
  const Amount_X__c:number;
  export default Amount_X__c;
}
declare module "@salesforce/schema/Contact.Amount_Y__c" {
  const Amount_Y__c:number;
  export default Amount_Y__c;
}
