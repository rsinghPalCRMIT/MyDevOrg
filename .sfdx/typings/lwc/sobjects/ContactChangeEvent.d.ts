...
declare module "@salesforce/schema/ContactChangeEvent.Age__c" {
  const Age__c:number;
  export default Age__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Amount_X__c" {
  const Amount_X__c:number;
  export default Amount_X__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Amount_Y__c" {
