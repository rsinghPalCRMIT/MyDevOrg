...
declare module "@salesforce/schema/Lead.ConnectionReceived" {
  const ConnectionReceived:any;
  export default ConnectionReceived;
}
declare module "@salesforce/schema/Lead.ConnectionReceivedId" {
  const ConnectionReceivedId:any;
  export default ConnectionReceivedId;
}
declare module "@salesforce/schema/Lead.ConnectionSent" {
  const ConnectionSent:any;
  export default ConnectionSent;
}
declare module "@salesforce/schema/Lead.ConnectionSentId" {
