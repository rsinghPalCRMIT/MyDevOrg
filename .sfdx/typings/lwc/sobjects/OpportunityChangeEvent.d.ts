...
declare module "@salesforce/schema/OpportunityChangeEvent.Registration__c" {
  const Registration__c:string;
  export default Registration__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Application_Submitted__c" {
  const Application_Submitted__c:boolean;
  export default Application_Submitted__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Country__c" {
...
declare module "@salesforce/schema/OpportunityChangeEvent.Needs_Insurance__c" {
  const Needs_Insurance__c:boolean;
  export default Needs_Insurance__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Needs_Waiver__c" {
  const Needs_Waiver__c:boolean;
  export default Needs_Waiver__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Promo_Code__c" {
  const Promo_Code__c:string;
  export default Promo_Code__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Adventure_Cost__c" {
  const Adventure_Cost__c:number;
  export default Adventure_Cost__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.External_Id__c" {
